...
<div style="clear:both;">  </div>
 <a href="video.php"><img src="img/back_icon.png" class="tool_icon shake mt-5 mr-b"/></a>';
...
echo '<div style="height:150px !important; text-align:center;" class="alert alert-info mr-b"> There is no video for this product (:</div>
...
header("refresh:2;url=http://localhost:8080/website/boss/video.php?video_code=".$_GET['video_code']. "  ",true);
