...
echo '<a  href="add_category.php"  ><img src="img/cat_icon.png" class="tool_icon shake"/> <label class="label_font ">Add category </label></a></div>';




echo '<div><a href="add_item.php" ><img src="img/item_icon.png" class="add_item shake"/><label class="label_font" style="margin-right:15%;">Add Product </label></a>';
