...
echo '<div class="mr-b"><a class="nav-link active link-style btn btn-primary"  aria-current="page" style="float:left; margin-left:20%;margin-top:5%;" href="cardd.php">Complete shoping</a>';




echo'<a href="index.php" class="tool_icon"><img src="img/home_icon.png" class="tool_icon shake mr-b"/></a></div>';
...
echo '<div class="card mt-5 cards-style" style="width: 18rem;">
  <img style="min-height:200px !important;   max-height:200px !important;" src="'.$data['p_img']. '" class="card-img-top" alt="Photo"/>
 ...
 <li class="list-group-item px-4">  <a  href="add_videos.php?product_id_cod='.$data['p_id']. '">   add_video</a></li>';
...
echo '<li class="list-group-item px-4"><a href="video.php?video_code='.$vid['pro_id'].'" > Watch Video </a></li>';
  ...
  echo   '<li class="list-group-item px-4"><a href="product_details.php?pro_detail='.$data['p_id'].'"> detail </a>
    
  
  
  
  <li class="list-group-item px-4"><a href="edit_product_data.php?product_id_code='.$data['p_id']. '">   edit</a></li>
