...
echo '<div class="card mt-5 mr-b" style="width: 22rem; margin-left:25%;">
 ...
 <li class="list-group-item px-4">  <a  href="add_videos.php?product_id_cod='.$_data['p_id']. '">   add_video</a></li>';
...
echo '<li class="list-group-item px-4"><a href="video.php?video_code='.$vid['pro_id'].'" > Watch Video </a></li>';
  ...
  <li class="list-group-item px-4"><a href="edit_product_data.php?product_id_code='.$_data['p_id']. '">   edit</a></li>
...
echo '<script>
setTimeout(function(){
            window.location.href ="http://localhost:8080/website/admin/cardd.php"
         }, 500); </script>';
